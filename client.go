...
// DefaultClientOptions read from the environment (VERS_API_KEY). This should be
...
// environment (VERS_API_KEY). The option passed in as arguments are applied after
