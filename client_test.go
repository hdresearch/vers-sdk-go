...
func TestUserAgentHeader(t *testing.T) {
	...
	client.API.Cluster.List(context.Background())
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.API.Cluster.List(context.Background())
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.API.Cluster.List(cancelCtx)
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.API.Cluster.List(deadlineCtx)
		if err == nil {
