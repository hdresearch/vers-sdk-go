...
func TestUserAgentHeader(t *testing.T) {
	...
	client.Orchestrator.Vm.NewRoot(context.Background(), vers.OrchestratorVmNewRootParams{
		NewRootRequest: vers.NewRootRequestParam{
			VmConfig: vers.F(vers.NewRootRequestVmConfigParam{}),
		},
	})
	if userAgent != fmt.Sprintf("Vers/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Orchestrator.Vm.NewRoot(context.Background(), vers.OrchestratorVmNewRootParams{
		NewRootRequest: vers.NewRootRequestParam{
			VmConfig: vers.F(vers.NewRootRequestVmConfigParam{}),
		},
	})
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Orchestrator.Vm.NewRoot(cancelCtx, vers.OrchestratorVmNewRootParams{
		NewRootRequest: vers.NewRootRequestParam{
			VmConfig: vers.F(vers.NewRootRequestVmConfigParam{}),
		},
	})
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Orchestrator.Vm.NewRoot(deadlineCtx, vers.OrchestratorVmNewRootParams{
			NewRootRequest: vers.NewRootRequestParam{
				VmConfig: vers.F(vers.NewRootRequestVmConfigParam{}),
			},
		})
